...
void Core::Execute(std::vector<std::pair<std::string, std::string>> latch_IDRF)
{
...
void Core::Memory(std::vector<std::pair<std::string, std::string>> latch_EXE, char *RAM)
{
    std::string opcode;
    latch_MEM = latch_EXE;
    for (const auto &pair : latch_EXE)
...
void Core::WriteBack(std::vector<std::pair<std::string, std::string>> latch_MEM)
{
